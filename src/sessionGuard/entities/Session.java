...
import sessionGuard.gui.entity.StatusPanel;
...
public class Session {
	...
	private SessionValidationConfig validationConfig = new SessionValidationConfig();
	private SessionValidationState validationState = SessionValidationState.UNKNOWN;
	private long lastValidationTimestamp = 0L;
	...
	public SessionValidationConfig getValidationConfig() {
		return validationConfig;
	}

	public void setValidationConfig(SessionValidationConfig validationConfig) {
		if(validationConfig == null) {
			this.validationConfig = new SessionValidationConfig();
		}
		else {
	...
	public int getRenewalFailureCount() {
		return renewalFailureCount;
	}

	public void incrementRenewalFailureCount() {
		renewalFailureCount++;
	}

	public void resetRenewalFailureCount() {
		renewalFailureCount = 0;
	}

	public SessionValidationState getValidationState() {
		return validationState;
	}

	public void setValidationState(SessionValidationState validationState) {
